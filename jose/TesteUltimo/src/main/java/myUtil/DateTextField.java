...
public class DateTextField extends JTextField {
    ...
    private class DatePanel extends JPanel implements ChangeListener {
        ...
        Color palletTableColor = Color.BLACK;
        Color todayBackColor = Color.GREEN;
        Color weekFontColor = Color.GREEN;
        Color dateFontColor = Color.green;
        Color weekendFontColor = Color.GREEN;

        Color controlLineColor = Color.black;
        Color controlTextColor = Color.GREEN;
